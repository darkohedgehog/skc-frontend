...
export const FeaturedImages = ({
  ...
  const t = useTranslations("FeaturedImages");
  const [hoveredIndex, setHoveredIndex] = useState<number | null>(null);

  // Populate testimonials dynamically with translations
  const testimonials = [
    {
      name: t("name1"),
      designation: t("designation1"),
      image: "/assets/knjiga.webp",
    },
    {
      name: t("name2"),
      designation: t("designation2"),
      image: "/assets/izlozba.webp",
    },
    {
      name: t("name3"),
      designation: t("designation3"),
      image: "/assets/muzika.webp",
    },
    {
      name: t("name4"),
      designation: t("designation4"),
      image: "/assets/pisanje.webp",
    },
    {
      name: t("name5"),
      designation: t("designation5"),
      image: "/assets/predavanja.webp",
    },
    {
      name: t("name6"),
      designation: t("designation6"),
      image: "/assets/radionica.webp",
    },
  ];
